...
<head>
    ...
    <title>LeoGarden - Admin Dashboard</title>
    ...
    <!-- toaster -->
    <link href="{{ asset('backend/assets/plugins/toaster/toaster.min.css') }}" rel="stylesheet" />
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                            <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                ...
                                <span class="d-none d-lg-inline-block"> {{ Auth::user()->name }} </span>   {{--Abdus Salam--}}
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <!-- User image -->
                                <li class="dropdown-header">
                                    ...
                                    <div class="d-inline-block">
                                        {{-- {{ Auth::user()->name }}--}}My Email <small class="pt-1">{{ Auth::user()->email }}</small> {{--Abdus Salam--}}{{--abdus@gmail.com--}}
                                    </div>
                                </li>
...
-->
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    &copy; <span id="copy-year">2021</span> Copyright Template by
                    <a
                        class="text-primary"
                        href="http://leogarden.com.ua/dev"
                        target="_blank"
                    >MrNezoooo</a>
                    >.
                </p>
...
<!-- Summernote -->
<script src="{{ asset('backend/assets/plugins/medium-editor/medium-editor.js') }}"></script>
