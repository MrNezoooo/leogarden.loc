            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{ route('dashboard') }}">
                        <span class="nav-text">Пульт</span>
                    </a>
                </li>
                ...
                <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard"
                       aria-expanded="false" aria-controls="dashboard">
                        ...
                        <span class="nav-text">Замовлення</span> <b class="caret"></b>
                    </a>
                        ...
                        <div class="sub-menu">
                            ...
                            <li >
                                <a class="sidenav-item-link" href="analytics.html">
                                    <span class="nav-text">Про Нас</span>
                            ...
                            <li >
                                <a class="sidenav-item-link" href="analytics.html">
                                    <span class="nav-text">Шоу-рум</span>
                                </a>
                            </li>

                            <li >
                                <a class="sidenav-item-link" href="{{ route('all.suppliers') }}">
                                    <span class="nav-text">Постачальники</span>
                ...
                <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#ui-elements"
                       aria-expanded="false" aria-controls="ui-elements">
                        ...
                        <span class="nav-text">Каталог</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="ui-elements"
                        ...
                        <div class="sub-menu">
                            ...
                            <li  class="has-sub" >
                                <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#widgets"
                                   aria-expanded="false" aria-controls="widgets">
                                    <span class="nav-text">Товари</span> <b class="caret"></b>
                                </a>
                                <ul  class="collapse"  id="widgets">
                                    <div class="sub-menu">

                                        <li >
                                            <a href="{{ route('all.product') }}">Всі товари</a>
                                        </li>

                                        <li >
                                            <a href="{{ route('add.product') }}">Добавити новий товар</a>
                                        </li>
                            ...
                            <li  class="has-sub" >
                                ...
                                <a class="sidenav-item-link" href="{{ route('all.subcategory') }}">
                                    <span class="nav-text">Підкатегорії</span>
                                </a>
