@extends('layouts.master_home_OLD')
...
<section id="about-us" class="about-us">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2><strong>ЛеоГарден - надійний інтернет магазин садових та декоративних рослин для дому та саду поштою</strong></h2>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box iconbox-blue">
                    ...
                    <h4><a href="">Швидка доставка</a></h4>
                    <p>1-2 дня</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                <div class="icon-box iconbox-orange ">
                    ...
                    <h4><a href="">Нова система зберігання</a></h4>
                    <p>Безпечна і швидка доставка</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
                <div class="icon-box iconbox-pink">
                    <div class="icon">
                        ...
                        <i class="bx bx-shield-quarter"></i>"></i>
                    </div>
                    <h4><a href="">Безпечна оплата</a></h4>
                    <p>будь-яким способом</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box iconbox-yellow">
                    ...
                    <h4><a href="">Тільки перевірені</a></h4>
                    <p>товари</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
                <div class="icon-box iconbox-red">
                    ...
                    <h4><a href="">Купуючи у нас, Ви нічим не ризикуєте</a></h4>
                    <p>Чесна гарантія повернення грошей</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
                <div class="icon-box iconbox-teal">
                    ...
                    <h4><a href="">Високі європейські стандарти</a></h4>
                    <p>Ретельна перевірка кожної рослини</p>
                </div>
            </div>
        ...
        <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
            ...
            <div class="col-lg-3 col-md-4 col-6">
                <div class="client-logo">
                    <img src="{{ $supplier->supplier_image  }}" class="img-fluid" alt="">
                </div>
            </div>
            @endforeach
        </div>
